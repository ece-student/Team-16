...
We used a different method to get the values for FFT. On the Open Music Lab Library, we used the sketch they had (fft_adc_serial), rather than use analogRead
